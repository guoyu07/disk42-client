...
const QString kDefaultServerAddr1 = "https://cloud.disk42.com"; //"https://seacloud.cc"; //disk42
...
LoginDialog::LoginDialog(QWidget *parent) : QDialog(parent)
{
    ...
    mServerAddr->setCurrentIndex(0); //disk42
    mServerAddr->setVisible(false); //disk42

    hint->setVisible(false); //disk42
    hint_2->setVisible(false); //dis42
